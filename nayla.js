...
const isOwner = ownerNumber == sender ? true : ["6282135278036@s.whatsapp.net","6282135278036@s.whatsapp.net","6282135278036@s.whatsapp.net"].includes(sender) ? true : false
